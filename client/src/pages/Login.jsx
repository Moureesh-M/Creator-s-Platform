...
const subtitleStyle = { textAlign: 'center', color: '#666', marginBottom: '2rem' }
const placeholderStyle = { backgroundColor: '#f8f9fa', padding: '1.5rem', borderRadius: '5px', marginBottom: '1rem' }
