    ...
    <div style={containerStyle}>
      <div style={heroStyle}>
        ...
        <p style={subtitleStyle}>
          A platform for creators to publish, connect, and grow their audience.
        </p>
        <div style={ctaStyle}>
      ...
      <div style={featuresStyle}>
        <h2>Why Choose Creator Platform?</h2>
...
const titleStyle = { fontSize: '3rem', marginBottom: '1rem', color: '#333' }
